...
- **Lucide-React** — icons
- **Netlify Functions** (Node.js) — API proxying with SSE streaming
...
| `LLM_TIMEOUT_MS` | No | Upstream LLM time-to-first-byte timeout in ms, default 60000 |
...
│   ├── lib/
│   │   ├── api.js                # fetchMarketData(), askLLMStream(), fetchModels()
...
│       └── ChatBot.jsx           # AI chat with settings, streaming, markdown
```
